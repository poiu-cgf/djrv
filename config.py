...
# client vars
API_ID = int(getenv("API_ID, "25146373"))
API_HASH = getenv("API_HASH", "061d67ee8eed9368c5cadabb4aa21efc")
BOT_TOKEN = getenv("BOT_TOKEN", "7844277668:AAGxVnltDPLNLNtP6Uvs4oO0nIQOLCsqVuE")
...
# mandatory vars
OWNER_USERNAME = getenv("OWNER_USERNAME", "EM_2_2")
ALIVE_NAME = getenv("ALIVE_NAME", "SPEED")
BOT_USERNAME = getenv("BOT_USERNAME", "S_C4BOT")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/STKR2/2004")
UPSTREAM_BRANCH = getenv("UPSTREM_BRANCH", "main")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "EM_2_2")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "IIIllIllIIllI")

# database, decorators, handlers mandatory vars
MONGODB_URL = getenv("MONGODB_URL", "mongodb+srv://veez:mega@cluster0.heqnd.mongodb.net/veez?retryWrites=true&w=majority")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! . $").split())
OWNER_ID = list(map(int, getenv("OWNER_ID", "6809738612").split()))
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6809738612").split()))
